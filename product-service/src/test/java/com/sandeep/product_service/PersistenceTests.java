...
public class PersistenceTests extends MongoDbTestBase {
	...
	void create() {
		...
		StepVerifier.create(repository.findById(newEntity.getId()))
				.expectNextMatches(foundEntity -> areProductEqual(foundEntity, newEntity)).verifyComplete();
	...
	void getByProductId() {
		StepVerifier.create(repository.findByProductId(savedEntity.getProductId()))
				.expectNextMatches(foundEntity -> areProductEqual(foundEntity, savedEntity)).verifyComplete();
	}
